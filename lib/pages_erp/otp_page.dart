        ...
        child: Scaffold(
          body: SingleChildScrollView(
            ...
            Padding(
              ...
              child: Container(
                child: Text("+91 9876* ***20",style: TextStyle(fontSize: 16,fontWeight: FontWeight.w700,color: Color.fromRGBO(35, 133, 59, 1)),),
          ...
          contentPadding: EdgeInsets.only(top: 11),
            ...
            Padding(
              ...
              child:ElevatedButton(onPressed: () { 
                Navigator.pushNamed(context, MyRoutes.ChangePassRoute);
              }, 
              child: Text("Verify",style: TextStyle(fontSize: 14,fontWeight:FontWeight.w500)),
