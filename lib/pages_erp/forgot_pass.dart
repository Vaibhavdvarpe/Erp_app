          ...
          body: SingleChildScrollView(
            child: Column(children: [
                    ...
                    Padding(
                      ...
                      children: [
                      Padding(
                        padding: EdgeInsets.only(left: 63,right: 47,top: 53,bottom: 43),
                        child: Container(width:250,height: 128,
                   ...
                   Padding(
                    ...
                    child: SvgPicture.asset("assets/svg/green_dots.svg",width: 50,height: 6,),),
            Row(mainAxisAlignment: MainAxisAlignment.center,
              children: const [
            ...
            Row(mainAxisAlignment: MainAxisAlignment.center,
              children: const [
                Text("from previous used passwords.",style: TextStyle(fontSize: 14,fontWeight: FontWeight.w400)),
              ],
            ),
            Padding(
              padding: const EdgeInsets.only(top: 17,left: 28,right: 26,bottom: 5),
                            ...
                            Column(
                              children: [
                                Padding(
                                  ...
                                  child: Container(height: 21,width: 170,
                                  child: const Padding(
              ...
              Padding(
              padding: const EdgeInsets.only(left: 9,right: 120,bottom: 17),
              child: Text("Must be at least 8 Characters.",style: TextStyle(color: Color.fromARGB(255, 126, 117, 117),fontSize: 12,fontWeight: FontWeight.w500),),
            ),
            Padding(
              padding: const EdgeInsets.only(bottom: 5,left: 28,right: 26),
              child: Container(height: 50,width: 321,
                        decoration: BoxDecoration(
                          border: Border.all(color: Colors.grey),borderRadius: BorderRadius.circular(16),
                        ),  
                          ...
                          children: [
                            ...
                            Column(
                              children: [
                                Padding(
                                  padding: const EdgeInsets.only(top: 20,bottom:7 ),
                                  child: Container(height: 21,width: 150,
                                  child: const Padding(
                                    padding: EdgeInsets.only(bottom: 1),
                                    child: TextField(
                                      obscureText: true,
            ...
            Padding(
              padding: const EdgeInsets.only(left: 10,right: 120,bottom: 17),
              child: Text("Both Passwords must match.",style: TextStyle(color: Color.fromARGB(255, 126, 117, 117),fontSize: 12,fontWeight: FontWeight.w500)),
            ),
            Padding(
              ...
              child: Row(mainAxisAlignment: MainAxisAlignment.center,
               children: [
                ...
                child: Text("Reset Password",style: TextStyle(fontSize: 14,fontWeight:FontWeight.w500)),
